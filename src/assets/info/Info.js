...
export const info = {
  ...
  miniBio: [
    ...
    {
      emoji: '🇨🇦',
      text: 'based in the New Delhi, India',
    },
    {
      emoji: '💻',
      text: 'Previously at Digital Management, Inc',
    },
    {
      emoji: '📧',
      text: 'pawas.agrwl@gmail.com',
    },
    {
      emoji: '📞',
      text: '+91 93552 20966',
  ...
  socials: [
    ...
    {
      link: 'https://github.com/pawasagrwl',
      icon: 'fa fa-github',
      label: 'github',
    },
    {
  ...
  bio: "Hello! I'm Pawas Aggarwal. I'm a Full-Stack Developer. I graduated from Purdue University, Indianapolis in August 2022 with Bachelor of Science in Computer Science. I enjoy building web applications and learning new technologies. I'm currently working at commonsku as a Full Stack Developer. I'm also a freelance photographer. I love to travel and explore new places. I'm currently based in Toronto, Canada.",
  skills: {
